    ...
    >
      ...
      >
        <div>
          ...
          >
            Crypto signal<br />analysis, simplified.
          </h2>
          <p className="text-sm mb-10 leading-relaxed" style={{ color: 'rgba(255,255,255,0.4)' }}>
            8 technical indicators fused into a single score, confirmed by Claude AI.
          </p>
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-12 relative z-10">
        ...
        >
          ...
          <h1 className="mb-1 text-2xl font-bold tracking-tight" style={{ color: '#ffffff' }}>Welcome back</h1>
          <p className="mb-8 text-sm" style={{ color: 'rgba(255,255,255,0.3)' }}>Sign in to your account</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Email */}
            <div>
              <label className="mb-2 block text-xs font-medium" style={{ color: 'rgba(255,255,255,0.4)' }}>
                Email
              </label>
